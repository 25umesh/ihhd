...
def register():
    ...
    # Removed: Hackathon/Internship/College ID requirements
    ...
    # Removed: Instagram/LinkedIn follow proof uploads

    # Payment proof removed per request

    # Removed: Profile photo and Proof of Identity collection/validation
        ...
        registration = {
            ...
            # Removed profile photo, identity proof, college ID,
            # and follow/certificate files
